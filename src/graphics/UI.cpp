...
namespace engine {
	namespace render {
		namespace ui {
			...
			void prepareText(
				int fontId, float scale, gs::Color fillColor, 
				...
				float backgroundThickness, gs::Color backgroundColor)
			{
				...
				text.setFont(font);
				text.getText().setCharacterSize(defaultCharacterSize * scale); 
			...
			void renderText(
				...
				bool centered, float scale, gs::Color fillColor, 
				float outlineThickness, gs::Color outlineColor, 
				float backgroundThickness, gs::Color backgroundColor)
			{
				prepareText(
				...
				bool centered, bool ignoreRendering)
			{
				...
				text.setPosition(
					std::floor(text.getPosition().x), 
					std::floor(text.getPosition().y)
				); 
				...
				RemappingButton& button, bool selected) 
			{
				...
				keyNameText.getText().setCharacterSize(
					defaultCharacterSize * button.getTextScale().x
				);
			...
			const gs::Vec2f creativeInventoryTabSize = gs::Vec2f(24.0, 24.0f);
			...
			gs::Button worldCreateWorldGameModeButton;
			...
			sf::Texture tabTextures[numOfTabTextures];
			sf::Sprite tabSprite;
			sf::Texture sliderTextures[2];
			gs::Slider inventorySlider;
			bool freezeInventorySlider = false; 
			int inventoryRowOffset = 0; 
			...
			bool itemEraseSlotSelected = false; 
			int creativeInventoryTabSelected = 0; 
			Item::Id creativeInventoryItems[numOfCreativeInventoryTabs][maxNumOfCreativeInventoryItems] =
			{
				{},
				{
					Item(Block::OakLog).id, Item(Block::OakPlanks).id, Item(Block::SpruceLog).id, Item(Block::SprucePlanks).id, Item(Block::BirchLog).id, Item(Block::BirchPlanks).id, Item(Block::JungleLog).id, Item(Block::JunglePlanks).id, Item(Block::AcaciaLog).id,
					Item(Block::AcaciaPlanks).id, Item(Block::Stone).id, Item(Block::Cobblestone).id, Item(Block::Granite).id, Item(Block::Diorite).id, Item(Block::Andesite).id, Item(Block::Deepslate).id, Item(Block::CobbledDeepslate).id, Item(Block::Sandstone).id
				}, // Building Blocks
				{
					Item(Block::GrassBlock).id, Item(Block::Dirt).id, Item(Block::ClayBlock).id, Item(Block::Gravel).id, Item(Block::Sand).id, Item(Block::Sandstone).id, Item(Block::Stone).id, Item(Block::Deepslate).id, Item(Block::Granite).id,
					Item(Block::Diorite).id, Item(Block::Andesite).id, Item(Block::CoalOre).id, Item(Block::DeepslateCoalOre).id, Item(Block::IronOre).id, Item(Block::DeepslateIronOre).id, Item(Block::CopperOre).id, Item(Block::DeepslateCopperOre).id, Item(Block::GoldOre).id,
					Item(Block::DeepslateGoldOre).id, Item(Block::RedstoneOre).id, Item(Block::DeepslateRedstoneOre).id, Item(Block::EmeraldOre).id, Item(Block::DeepslateEmeraldOre).id, Item(Block::LapizOre).id, Item(Block::DeepslateLapizOre).id, Item(Block::DiamondOre).id, Item(Block::DeepslateDiamondOre).id,
					Item(Block::OakLog).id, Item(Block::SpruceLog).id, Item(Block::BirchLog).id, Item(Block::JungleLog).id, Item(Block::AcaciaLog).id, Item(Block::OakLeaves).id, Item(Block::SpruceLeaves).id, Item(Block::BirchLeaves).id, Item(Block::JungleLeaves).id,
					Item(Block::AcaciaLeaves).id, Item(Block::OakSapling).id, Item(Block::SpruceSapling).id, Item(Block::BirchSapling).id, Item(Block::JungleSapling).id, Item(Block::AcaciaSapling).id, Item(Block::BrownMushroom).id, Item(Block::RedMushroom).id, Item(Block::Grass).id,
					Item(Block::Fern).id, Item(Block::DeadBush).id, Item(Block::Dandelion).id, Item(Block::Poppy).id, Item(Block::BlueOrchid).id, Item::Bamboo, Item(Block::Cactus).id, Item::WheatSeeds, Item(Block::MelonBlock).id,
					Item(Block::Pumpkin).id, Item(Block::CarvedPumpkin).id, Item(Block::JackOLantern).id, Item(Block::Bedrock).id
				}, // Natural Blocks
				{
					Item::Torch, Item(Block::CraftingTable).id, Item(Block::Furnace).id, Item(Block::Chest).id
				}, // Functional Blocks
				{
					Item(Wall::Dirt).id, Item(Wall::Stone).id, Item(Wall::Deepslate).id, Item(Wall::Sand).id, Item(Wall::Cobblestone).id, Item(Wall::MossyCobblestone).id
				}, // Walls
				{
					Item(Block::OakLog).id, Item(Block::OakPlanks).id, Item(Block::SpruceLog).id, Item(Block::SprucePlanks).id, Item(Block::BirchLog).id, Item(Block::BirchPlanks).id, Item(Block::JungleLog).id, Item(Block::JunglePlanks).id, Item(Block::AcaciaLog).id,
					Item(Block::AcaciaPlanks).id, Item(Block::Stone).id, Item(Block::Cobblestone).id, Item(Block::Granite).id, Item(Block::Diorite).id, Item(Block::Andesite).id, Item(Block::Deepslate).id, Item(Block::CobbledDeepslate).id, Item(Block::Sandstone).id,
					Item(Block::GrassBlock).id, Item(Block::Dirt).id, Item(Block::ClayBlock).id, Item(Block::Gravel).id, Item(Block::Sand).id, Item(Block::Sandstone).id, Item(Block::Stone).id, Item(Block::Deepslate).id,
					Item(Block::CoalOre).id, Item(Block::DeepslateCoalOre).id, Item(Block::IronOre).id, Item(Block::DeepslateIronOre).id, Item(Block::CopperOre).id, Item(Block::DeepslateCopperOre).id, Item(Block::GoldOre).id,
					Item(Block::DeepslateGoldOre).id, Item(Block::RedstoneOre).id, Item(Block::DeepslateRedstoneOre).id, Item(Block::EmeraldOre).id, Item(Block::DeepslateEmeraldOre).id, Item(Block::LapizOre).id, Item(Block::DeepslateLapizOre).id, Item(Block::DiamondOre).id, Item(Block::DeepslateDiamondOre).id,
					Item(Block::OakLeaves).id, Item(Block::SpruceLeaves).id, Item(Block::BirchLeaves).id, Item(Block::JungleLeaves).id,
					Item(Block::AcaciaLeaves).id, Item(Block::OakSapling).id, Item(Block::SpruceSapling).id, Item(Block::BirchSapling).id, Item(Block::JungleSapling).id, Item(Block::AcaciaSapling).id, Item(Block::BrownMushroom).id, Item(Block::RedMushroom).id, Item(Block::Grass).id,
					Item(Block::Fern).id, Item(Block::DeadBush).id, Item(Block::Dandelion).id, Item(Block::Poppy).id, Item(Block::BlueOrchid).id, Item::Bamboo, Item(Block::Cactus).id, Item::WheatSeeds, Item(Block::MelonBlock).id,
					Item(Block::Pumpkin).id, Item(Block::CarvedPumpkin).id, Item(Block::JackOLantern).id, Item(Block::Bedrock).id, Item::Torch, Item(Block::CraftingTable).id, Item(Block::Furnace).id, Item(Block::Chest).id, 
					Item(Wall::Dirt).id, Item(Wall::Stone).id, Item(Wall::Deepslate).id, Item(Wall::Sand).id, Item(Wall::Cobblestone).id, Item(Wall::MossyCobblestone).id, Item::WoodenPickaxe, Item::WoodenAxe, Item::WoodenShovel, Item::WoodenHoe, Item::StonePickaxe, Item::StoneAxe, Item::StoneShovel, Item::StoneHoe, Item::IronPickaxe,
					Item::IronAxe, Item::IronShovel, Item::IronHoe, Item::GoldPickaxe, Item::GoldAxe, Item::GoldShovel, Item::GoldHoe, Item::DiamondPickaxe, Item::DiamondAxe,
					Item::DiamondShovel, Item::DiamondHoe, Item::Bucket, Item::WaterBucket, Item::LavaBucket, Item::WoodenSword, Item::StoneSword, Item::IronSword, Item::GoldSword, Item::DiamondSword,
					Item::Apple, Item::MelonSlice, Item::Carrot, Item::Potato, Item::BakedPotato, Item::Beef, Item::Steak, Item::Porkchop, Item::CookedPorkchop,
					Item::Bread, Item::RottenFlesh, Item::Coal, Item::RawIron, Item::RawCopper, Item::RawGold, Item::Emerald, Item::Lapiz, Item::Diamond, Item::IronIngot, Item::GoldIngot,
					Item::Stick, Item::Wheat, Item::Bone, Item::BoneMeal, Item::Redstone, Item::GunPowder

				}, // Search Items,
				{
					Item::WoodenPickaxe, Item::WoodenAxe, Item::WoodenShovel, Item::WoodenHoe, Item::StonePickaxe, Item::StoneAxe, Item::StoneShovel, Item::StoneHoe, Item::IronPickaxe,
					Item::IronAxe, Item::IronShovel, Item::IronHoe, Item::GoldPickaxe, Item::GoldAxe, Item::GoldShovel, Item::GoldHoe, Item::DiamondPickaxe, Item::DiamondAxe,
					Item::DiamondShovel, Item::DiamondHoe, Item::Bucket, Item::WaterBucket, Item::LavaBucket
				}, // Tools & Utilities
				{
					Item::WoodenSword, Item::StoneSword, Item::IronSword, Item::GoldSword, Item::DiamondSword, Item::WoodenAxe, Item::StoneAxe, Item::IronAxe, Item::GoldAxe,
					Item::DiamondAxe
				}, // Combat
				{
					Item::Apple, Item::MelonSlice, Item::Carrot, Item::Potato, Item::BakedPotato, Item::Beef, Item::Steak, Item::Porkchop, Item::CookedPorkchop,
					Item::Bread, Item::RottenFlesh,
				}, // Food
				{
					Item::Coal, Item::RawIron, Item::RawCopper, Item::RawGold, Item::Emerald, Item::Lapiz, Item::Diamond, Item::IronIngot, Item::GoldIngot,
					Item::Stick, Item::Wheat, Item::Bone, Item::BoneMeal, Item::Redstone, Item::GunPowder
				} // Ingredients
			};
			int creativeInventoryItemSelected = -1; 
			...
			sf::RectangleShape chatMessageBar;
			...
			void loadAssets() {
				...
				// Load in tab textures
				for (int tabTextureIndex = 0; tabTextureIndex <
					numOfTabTextures; tabTextureIndex++)
				{
					addResourceLoader(ResourceLoader(
						ResourceLoader::Type::Texture, assetDirectory
							+ "textures/gui/container/tab"
							+ toString(tabTextureIndex) + ".png",
						&tabTextures[tabTextureIndex]
					)); 
				}

				// Load in slider textures
				for (int sliderTextureIndex = 0; sliderTextureIndex < 2;
					sliderTextureIndex++)
				{
					addResourceLoader(ResourceLoader(
						ResourceLoader::Type::Texture, assetDirectory
							+ "textures/gui/container/slider"
							+ toString(sliderTextureIndex) + ".png",
						&sliderTextures[sliderTextureIndex]
					));
				}
			...
			void handleAssets() {
				...
				titleYouTubeButton.setSelectedTextFillColor(gs::Color::White); 
				...
				worldCreateWorldGameModeButton.setSize(
					800.0f + (medialButtonGap * 2.0f), buttonHeight
				);
				worldCreateWorldGameModeButton.setPosition(
					(window::defaultWindowWidth / 2.0f) 
						- (worldCreateWorldGameModeButton.getSize().x / 2.0f), 
					worldCreateWorldSeedTextbox.getPosition().y
				);
				worldCreateWorldGameModeButton.move(0.0f, 118.0f);
				worldCreateWorldGameModeButton.setString(
					gameMode == GameMode::Survival ? "Game Mode: Survival"
						: "Game Mode: Creative"
				);
				prepareMenuButton(worldCreateWorldGameModeButton);
				...
				// Initialize the inventorySlider. 
				inventorySlider.setOnColor(gs::Color::Transparent); 
				inventorySlider.setOffColor(gs::Color::Transparent); 
				inventorySlider.setOnOutlineThickness(0.0f); 
				inventorySlider.setOffOutlineThickness(0.0f); 
				inventorySlider.button.clear(); 
			}
			...
			gs::Vec2f getInventorySlotPosition(int inventorySlotIndex) {
				...
				if (inventoryMenu == InventoryMenu::CreativeInventory)
					position.x += guiScale; 
			...
			gs::Vec2f getCreativeInventoryEraseSlotPosition() {
				gs::Vec2f position = containerSprite.getPosition();

				position.x += (containerSprite.getTexture()->getSize().x / 2.0f) * guiScale;
				position.y -= (containerSprite.getTexture()->getSize().y / 2.0f) * guiScale;

				position += gs::Vec2f(-14.0f, 120.0f) * guiScale;

				return position;
			}
			gs::Vec2f getCreativeInventoryTabPosition(int tabIndex, bool selected) {
				gs::Vec2f position = containerSprite.getPosition(); 
				...
				switch (tabIndex) {
				case 0:
					position += gs::Vec2f(-13.0f, 148.0f) * guiScale;
					if (!selected) position.y += -3.0f * guiScale;
					break; 
				case 1: case 2: case 3: case 4:
					position += gs::Vec2f(-182.0f, -12.0f) * guiScale; 
					position.x += (tabIndex - 1) * 27.0f * guiScale; 
					if (!selected) position.y += 3.0f * guiScale; 					
					break; 
				case 5:
					position += gs::Vec2f(-13.0f, -12.0f) * guiScale; 
					if (!selected) position.y += 3.0f * guiScale;
					break; 
				case 6: case 7: case 8: case 9:
					position += gs::Vec2f(-182.0f, 148.0f) * guiScale; 
					position.x += (tabIndex - 6) * 27.0f * guiScale; 
					if (!selected) position.y += -3.0f * guiScale; 
					break; 
				}
			...
			int getCreativeInventoryTabTextureIndex(int tabIndex, bool selected) {
				switch (tabIndex) {
				case 0:
					return selected ? 7 : 4;
				case 1: 
			...
			std::string getCreativeInventoryTabTitle(int tabIndex) {
				switch (tabIndex) {
				case 0:
					return "Inventory"; 
				case 1:
			...
			Item::Id getCreativeInventoryTabItemId(int tabIndex) {
				switch (tabIndex) {
				case 0:
					return static_cast<Item::Id>(1056); 
				case 1:
					return static_cast<Item::Id>(1051); 
				case 2:
					return static_cast<Item::Id>(1002); 
				case 3:
					return static_cast<Item::Id>(1055); 
				case 4:
					return static_cast<Item::Id>(2001); 
				case 5:
					return Item::Compass; 
				case 6:
			...
			gs::Vec2f getCreativeInventoryItemPosition(int itemSlotIndex) {
				const float containerSlotGapWidth = 18.0f * guiScale;
				const gs::Vec2i inventoryPosition = gs::Vec2i(
					itemSlotIndex % Player::numOfHotbarSlots,
					itemSlotIndex / Player::numOfHotbarSlots
				);
				...
				position += gs::Vec2f(17.0f, 26.0f) * guiScale;
				...
				const ItemContainer& itemContainer, gs::Vec2f position)
			{
				...
				if (itemContainer.count != 0) {
					...
					const gs::Color originalItemSpriteColor = itemSprite.getColor(); 

					itemSprite.setColor(gs::Color(0, 0, 0, 80));
					renderItem(itemContainer.item, position 
						+ gs::Vec2f(guiScale, guiScale * 1.0f), 10.0f * guiScale);
					itemSprite.setColor(originalItemSpriteColor); 
					...
					if (itemContainer.count > 1) {
						const std::string displayNumber =
							...
							itemContainer.count < 10 ? " "
								+ toString(itemContainer.count)
									: toString(itemContainer.count);
						const float textScale = guiScale * 0.3f;
						...
						renderText(
							...
							gs::Color(), 0.0f, gs::Color::Transparent
						);
			...
			void updateWorldCreateScreen() {
				...
				worldCreateWorldGameModeButton.update(); 
				worldCreateWorldSeedTextbox.update(); 
				worldCreateNewWorldButton.update();
				worldCreateCancelButton.update();

				if (worldCreateWorldGameModeButton.isSelected
					&& worldCreateWorldGameModeButton.isClickedOn)
				{
				...
				else if (worldCreateNewWorldButton.isSelected
			...
			void updateChat() {
				...
				if (!chatOpen) {
					if (input::isKeyClicked(input::OpenChat)) {
						chatOpen = true; 
						return; 
					}
					else if (input::isKeyClicked(input::OpenCommand)) {
						chatOpen = true; 
						messageString = "/"; 
						return; 
					}
					...
					if (input::isKeyClicked(input::MenuEscape)) {
						chatOpen = false;
						return; 
					}

					if (gs::input::priv::backSpace) {
						if (!messageString.empty())
							messageString.pop_back(); 
					}
					else if (gs::input::priv::enter) {
						if (!messageString.empty()) {
							Message message;
					...
					else if (gs::input::textUnicode != -1 
							&& messageString.size() < maxMessageLength) 
						messageString += static_cast<char>(gs::input::textUnicode);
				}
			}
			void updateIngameUI() {
				// Hotbar
				if (!input::isKeyPressed(input::Zoom) && !inventoryOpen) {
				...
				{
					if (input::isKeyClicked(hotbarKey) && !chatOpen) {
				...
				if (input::isKeyClicked(input::OpenInventory)
					&& !gamePaused && !gameOver && !chatOpen) 
				{
					inventoryMenu = gameMode == GameMode::Survival ?
						InventoryMenu::Inventory : InventoryMenu::CreativeInventory;
				...
				if (inventoryOpen) {
					...
					itemEraseSlotSelected = false; 
					creativeInventoryItemSelected = -1; 
					...
					{
						if (inventoryMenu == InventoryMenu::CreativeInventory
							&& creativeInventoryTabSelected != 0) 
						{
							if (inventorySlotIndex >= Player::numOfHotbarSlots)
								break; 
						}
					...
					case InventoryMenu::CreativeInventory:
					{
						if (creativeInventoryTabSelected == 0) {
							// Finds if item erase slot is selected. 

							const gs::Vec2f eraseSlotPosition =
								getCreativeInventoryEraseSlotPosition();
							const gs::Vec2f delta = eraseSlotPosition
								- gs::input::mousePosition;

							itemEraseSlotSelected = std::abs(delta.x) <
								(inventorySlotSize.x * guiScale) / 2.0f
									&& std::abs(delta.y) <
								(inventorySlotSize.y * guiScale) / 2.0f;

							// Handle erasing slot. 
							if (itemEraseSlotSelected) {
								itemPreviewString = "Destroy Item";

								if (gs::input::mouseClickL) {
									// Erases the item held. 
									temporaryItemContainer = ItemContainer(Item());

									if (input::isKeyPressed(input::ItemShift)) {
										// Erases items in the player's inventory. 
							...
							int maxInventoryTabItemIndex = 0;

							for (int inventoryTabIndex = 0; inventoryTabIndex <
								maxNumOfCreativeInventoryItems; inventoryTabIndex++)
							{
								const Item creativeInventoryItem =
									creativeInventoryItems[creativeInventoryTabSelected]
										[inventoryTabIndex];

								if (!creativeInventoryItem.isEmpty())
									maxInventoryTabItemIndex = inventoryTabIndex;
								else
									break;
							}

							const int numOfInventoryTabRows = 1 + std::max(
								(maxInventoryTabItemIndex - 1)
									/ Player::numOfHotbarSlots, 0
							);

							freezeInventorySlider = numOfInventoryTabRows <= 5; 

							const float prvsPercentage = 
								inventorySlider.getPercentage(); 

							gs::Vec2f position = containerSprite.getPosition();

							position.x += (containerSprite.getTexture()
								->getSize().x / 2.0f) * guiScale;
							position.y -= (containerSprite.getTexture()
								->getSize().y / 2.0f) * guiScale;

							position += gs::Vec2f(-20.0f, 18.0f) * guiScale; 

							inventorySlider.setSize(
								gs::Vec2f(12.0f, 110.0f) * guiScale
							); 
							inventorySlider.button.setSize(
								gs::Vec2f(12.0f, 15.0f) * guiScale
							); 
							inventorySlider.setPosition(position); 
							inventorySlider.button.setTexture(sliderTextures[
								freezeInventorySlider ? 0 : 1
							]); 
							inventorySlider.setPercentage(prvsPercentage); 

							const int extendedRowDelta =
								numOfInventoryTabRows - 5;

							if (!freezeInventorySlider) {
								inventorySlider.button.move(
									0.0f, 1.0f * (inventorySlider.getSize().y
										/ static_cast<float>(extendedRowDelta)) 
										* -window::mouseDelta
								);
							}

							inventorySlider.update(); 

							if (freezeInventorySlider) {
								inventorySlider.setPercentage(0.0f);
								inventoryRowOffset = 0; 
							}
							else {
								inventoryRowOffset = 
									std::round(inventorySlider.getPercentage(
										extendedRowDelta)); 
							}

							for (int localItemSlotIndex = 0; localItemSlotIndex <
								Player::numOfHotbarSlots * 5; localItemSlotIndex++)
							{
								const int itemSlotIndex = localItemSlotIndex
									+ inventoryRowOffset * Player::numOfHotbarSlots;
								const Item creativeInventoryItem =
									creativeInventoryItems[creativeInventoryTabSelected]
										[itemSlotIndex];

								const gs::Vec2f localSlotPosition =
									getCreativeInventoryItemPosition(
										localItemSlotIndex);
								const gs::Vec2f delta = localSlotPosition
									- gs::input::mousePosition; 

								if (std::abs(delta.x) < (inventorySlotSize.x * guiScale) / 2.0f
									&& std::abs(delta.y) < (inventorySlotSize.y * guiScale) / 2.0f)
								{
									creativeInventoryItemSelected = localItemSlotIndex; 

									if (!creativeInventoryItem.isEmpty()) 
										itemPreviewString = creativeInventoryItem.getName();
									
									ItemContainer creativeInventoryItemContainer =
										ItemContainer(creativeInventoryItem, 
											input::isKeyPressed(input::ItemShift) 
												? creativeInventoryItem.getVar(
									...
									if (gs::input::mouseClickL) {
										...
										addItemToInventory(
											creativeInventoryItemContainer,
											&temporaryItemContainer, 1
										); 

										if (temporaryItemContainer.item.id
											!= creativeInventoryItem.id)
										{
											temporaryItemContainer = 
												creativeInventoryItemContainer; 
										}
									}
									else if (gs::input::mouseClickR) {
										if (temporaryItemContainer.item.isEmpty())
											temporaryItemContainer = 
												creativeInventoryItemContainer; 
										else {
											...
											if (temporaryItemContainer.count <= 0)
												temporaryItemContainer.item = Item(); 
										}
									}
								}
							}
						...
						for (int tabIndex = 0; tabIndex <
							numOfCreativeInventoryTabs; tabIndex++)
						{
							const gs::Vec2f tabPosition =
								getCreativeInventoryTabPosition(tabIndex, false); 
							const gs::Vec2f delta = tabPosition 
								- gs::input::mousePosition; 

							if (std::abs(delta.x) <
								(creativeInventoryTabSize.x * guiScale) / 2.0f
									&& std::abs(delta.y) <
								(creativeInventoryTabSize.y * guiScale) / 2.0f)
							{
								itemPreviewString = 
									getCreativeInventoryTabTitle(tabIndex); 

								if (gs::input::mouseClickL) {
									creativeInventoryTabSelected = tabIndex; 
									break; 
								}
							}
						}
				...
				// Creative mode tile destruction. 
			...
			void renderTitleScreen() {
				...
				renderText(
					...
					gs::Vec2f(10.0f, 1050.0f), 0, false, 1.0f, gs::Color::White
				);
			...
			void renderWorldPreview(const WorldPreview& worldPreview, int index) {
				...
				renderText(
					worldPreview.worldName, position 
						+ gs::Vec2f(150.0f, 5.0f), 0, false, 1.5f
				);
				renderText(
				...
				renderText(
					worldPreview.gameMode + " Mode" + versionString, position 
						+ gs::Vec2f(150.0f, 8.0f + subTextOffset * 2.0f), 0, 
					false, 1.5f, subTextColor
				);
			...
			void renderWorldSelectionScreen() {
				...
				renderText(
					"Select World", gs::Vec2f(window::defaultWindowWidth 
						/ 2.0f, 100.0f), 0, true, 1.5f, gs::Color::White 
				); 
			...
			void renderWorldEditScreen() {
				...
				renderText(
					"Edit World", gs::Vec2f(window::defaultWindowWidth
						/ 2.0f, 80.0f), 0, true, 1.5f, gs::Color::White
				);
				renderText(
					"World Name", gs::Vec2f(565.0f, 125.0f), 0, false, 1.5f, 
			...
			void renderWorldCreateScreen() {
				...
				renderText(
					"Seed", gs::Vec2f(565.0f, 285.0f), 0, false, 1.5f, 
					gs::Color(127, 127, 127)
				);
				...
				renderMenuButton(worldCreateWorldGameModeButton);
			...
			void renderChangeLogScreen() {
				...
				renderText(
					"                Version 1.0                ",
					gs::Vec2f(window::defaultWindowWidth / 2.0f, 247.0f), 0, 
					true, 1.5f, gs::Color::Black, 0.0f, gs::Color(), 8.0f, 
					gs::Color(0, 255, 0, 127)
				);
				renderText(
					"Inital release. Note: MANY BUGS CURRENTLY EXIST",
					gs::Vec2f(window::defaultWindowWidth / 2.0f, 310.0f), 0, 
					true, 1.0f
				);
				renderText(
					"- Includes 9 biomes"
					...
					gs::Vec2f(window::defaultWindowWidth / 2.0f, 400.0f), 0, 
					true, 1.0f, gs::Color(200, 200, 200)
				);

				renderText(
					"  Version 1.1 - The Creative Update  ",
					gs::Vec2f(window::defaultWindowWidth / 2.0f, 500.0f), 0,
					true, 1.5f, gs::Color::Black, 0.0f, gs::Color(), 8.0f,
					gs::Color(0, 127, 255, 127)
				);
				renderText(
					"- Added chat"
					"\n- Added commands"
					...
					gs::Vec2f(window::defaultWindowWidth / 2.0f, 620.0f), 0,
					true, 1.0f, gs::Color(200, 200, 200)
				);
				...
				renderText(
					...
					gs::Vec2f(window::defaultWindowWidth / 2.0f, 100.0f), 0, 
					true, 1.2f, gs::Color(200, 200, 200)
				);
			...
			void renderDebugMenu() {
				...
				prepareText(
					0, 1.5f, gs::Color::White, 0.0f, gs::Color::Black, 
					backgroundThickness, gs::Color(60, 60, 60, 150)
				); 
			...
			void renderPauseMenu() {
				...
				renderText(
					"Pause Menu", gs::Vec2f(window::defaultWindowWidth / 2.0f, 
						300.0f), 0, true, 1.5f, gs::Color::White
				);
			...
			void renderGameOverMenu() {
				...
				renderText(
					"Game over!", gs::Vec2f(window::defaultWindowWidth
						/ 2.0f, 300.0f), 0, true, 2.5f, gs::Color::White
				);
			...
			void renderChat() {
				const float textScaler = 0.33f; 
				const gs::Vec2f defaultMessageBarSize = 
					gs::Vec2f(300.0f, defaultCharacterSize * textScaler); 
				const float messageVerticalOffset = 10.0f; 
				const int maxChatTimeDelta = window::framerate * 5; 
				const int maxNumOfDisplayedChatMessages = 20; 
				const int chatFadingDuration = window::framerate; 

				gs::Vec2f messageBarSize = defaultMessageBarSize * guiScale; 
				int messageIndex = chat.size() - 1; 

				auto renderChatMessage = [&](const Message& message, 
					int messageIndex, int timeDelta = 0) 
				{
					const int chatFadingStart = maxChatTimeDelta
						- chatFadingDuration;
					const float chatFadingAlphaScaler = 255.0f
						/ static_cast<float>(chatFadingDuration);
					const int alpha = 255 - (std::max(0, timeDelta -
						(maxChatTimeDelta - chatFadingDuration))
						* chatFadingAlphaScaler);
					const gs::Color messageColor = gs::Color(
						message.color.r, message.color.g,
						message.color.b, alpha
					);
					const gs::Vec2f messagePosition = gs::Vec2f(
						guiScale * 5.0f, window::defaultWindowHeight
							- ((messageIndex + 1) * messageBarSize.y)
					);

					chatMessageBar.setPosition(0.0f, messagePosition.y - guiScale);

					window::winmain->draw(chatMessageBar);

					renderText(
						message.text, messagePosition, 0, false,
						guiScale * textScaler, messageColor
					);
				}; 

				chatMessageBar.setSize(messageBarSize); 
				chatMessageBar.setFillColor(gs::Color(0, 0, 0, 127)); 

				if (chatOpen) {
					Message typingMessage; 

					typingMessage.text = messageString;

					if ((window::ticks / 30) % 2 == 0)
						typingMessage.text += '|'; 

					renderChatMessage(typingMessage, 0); 
				}

				while (messageIndex >= 0) {
					Message& message = chat[messageIndex]; 
					int timeDelta = render::window::ticks 
						- message.time;

					const int adjustedMessageIndex = chat.size() 
						- messageIndex - 1 + 3; 

					if (chatOpen)
						timeDelta = 0; 

					if (timeDelta < maxChatTimeDelta && adjustedMessageIndex 
						< maxNumOfDisplayedChatMessages) 
					{
						renderChatMessage(
							message, adjustedMessageIndex, timeDelta
						);
						messageIndex--;
					}
					else
			...
			void renderIngameUI() {
				if (!hideUIMenu) {
					...
					if (selectedItemNameTimeRemaining > 0.0f) {
						...
						const float itemNameScale = guiScale * 0.3f; 
					...
					if (inventoryOpen) {
						if (inventoryMenu == InventoryMenu::CreativeInventory) {
							for (int tabIndex = 0; tabIndex <
								numOfCreativeInventoryTabs; tabIndex++)
							{
								if (creativeInventoryTabSelected == tabIndex)
									continue; 

								const gs::Vec2f tabPosition =
									getCreativeInventoryTabPosition(tabIndex, false);

								tabSprite.setTexture(tabTextures[
									getCreativeInventoryTabTextureIndex(
										tabIndex, false
									)
								]);
								resizeSpriteBounds(tabSprite);
								tabSprite.setScale(guiScale, guiScale);
								tabSprite.setOrigin(
									tabSprite.getTexture()->getSize().x / 2.0f,
									tabSprite.getTexture()->getSize().y / 2.0f
								);
								tabSprite.setPosition(tabPosition);

								window::winmain->draw(tabSprite);
							}
						}

						// Handle and render the container sprite. 

						int containerTextureIndex = static_cast<int>(inventoryMenu);

						if (inventoryMenu == InventoryMenu::CreativeInventory
							&& creativeInventoryTabSelected != 0) 
						{
							containerTextureIndex++;

							if (creativeInventoryTabSelected == 5)
								containerTextureIndex++; 
						}
						...
						resizeSpriteBounds(containerSprite); 
						...
						case InventoryMenu::CreativeInventory:
						{
							if (creativeInventoryTabSelected == 0) {
								...
								previewPlayer.position += gs::Vec2f(-9.0f, -40.0f)
									/ (positionDivisor / guiScale);
								...
								if (itemEraseSlotSelected) {
									inventorySlotShadePosition =
										getCreativeInventoryEraseSlotPosition();
									inventorySlotTint = true;
								}
							}
							else {
								prepareText(0, guiScale * 0.33f,
									gs::Color(60, 60, 65));

								renderText(
									getCreativeInventoryTabTitle(
										creativeInventoryTabSelected), 
									containerSpriteCorner
										+ gs::Vec2f(8.0f, -129.0f) * guiScale
								);

								gs::draw(window::winmain, inventorySlider); 

								if (creativeInventoryItemSelected != -1) {
									inventorySlotShadePosition =
										getCreativeInventoryItemPosition(
											creativeInventoryItemSelected); 
								}
							}
							...
							for (int tabIndex = 0; tabIndex <
								numOfCreativeInventoryTabs; tabIndex++) 
							{
								const bool selectedTab = creativeInventoryTabSelected
									== tabIndex; 
								const gs::Vec2f tabPosition =
									getCreativeInventoryTabPosition(tabIndex, selectedTab); 
								...
								const Item tabItem = Item(
									getCreativeInventoryTabItemId(tabIndex)
								);

								renderItem(tabItem, tabPosition, 12.0f * guiScale);
							}
						}
							break; 
						case InventoryMenu::Crafting: 	
						...
						if (inventorySlotShadePosition != gs::Vec2f()) {
							...
							window::winmain->draw(
								inventorySlotShade, inventorySlotTint 
									? sf::BlendAdd : sf::BlendAlpha
							); 
						}
						...
						case InventoryMenu::CreativeInventory:
								...
								Player::numOfHotbarSlots * 5; localItemSlotIndex++)
							{
								const int itemSlotIndex = localItemSlotIndex 
									+ inventoryRowOffset * Player::numOfHotbarSlots;
								const ItemContainer itemContainer =
									ItemContainer(Item(creativeInventoryItems
										[creativeInventoryTabSelected][itemSlotIndex]), 1);

								renderInventoryItem(itemContainer,
									getCreativeInventoryItemPosition(localItemSlotIndex));
							}
							break; 
						case InventoryMenu::Crafting:
							...
							Player::numOfInventorySlots; inventoryIndex++)
						{
							if (inventoryMenu == InventoryMenu::CreativeInventory
								&& creativeInventoryTabSelected != 0)
							{
								if (inventoryIndex >= Player::numOfHotbarSlots)
									break;
							}
