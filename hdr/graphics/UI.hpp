...
namespace engine {
	namespace render {
		namespace ui {
			...
			constexpr int numOfWidgetTextures = 6; 
			constexpr int numOfRemappingButtons = 11; 
			constexpr int defaultCharacterSize = 30;
			...
			void renderText(
				...
				bool centered = false, float scale = 1.0f, 
				gs::Color fillColor = gs::Color::White, 
				float outlineThickness = 0.0f, 
				gs::Color outlineColor = gs::Color(),
				float backgroundThickness = 0.0f,
			...
			enum class InventoryMenu {
				None = -1, Inventory, Crafting, Furnace, Chest, CreativeInventory
			};
			...
			constexpr int numOfContainerTextures = 7; 
			constexpr int numOfCreativeInventoryTabs = 10; 
			constexpr int numOfTabTextures = 8; 
			constexpr int maxNumOfCreativeInventoryItems = 9 * 100; 
			...
			extern const gs::Vec2f creativeInventoryTabSize; 
			...
			extern gs::Button worldCreateWorldGameModeButton; 
			...
			extern sf::Texture tabTextures[numOfTabTextures]; 
			extern sf::Sprite tabSprite; 
			extern sf::Texture sliderTextures[2]; 
			extern gs::Slider inventorySlider; 
			extern int inventoryRowOffset; 
			extern bool freezeInventorySlider; 
			...
			extern bool itemEraseSlotSelected; 
			extern int creativeInventoryTabSelected; 
			extern Item::Id creativeInventoryItems[numOfCreativeInventoryTabs][maxNumOfCreativeInventoryItems]; 
			extern int creativeInventoryItemSelected; 
			...
			extern std::string messageString; 
			extern sf::RectangleShape chatMessageBar; 
			...
			gs::Vec2f getCreativeInventoryEraseSlotPosition(int tabIndex, bool selected);
